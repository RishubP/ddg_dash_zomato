...
class FlaskLoginAuth():
    def __init__(self, app, use_default_views=False, users=[
        ('admin','bain@123'),
        ('amit poddar','ddg@demo'),
        ('nimit mehta','ddg@demo'),
        ('stephanie wheeler','ddg@demo'),
	    ('chuck davenport','ddg@demo'),
        ('jesse klein','ddg@demo'),
        ('ankit tibra','ddg@demo'),
        ('dhruv walia','ddg@demo'),
        ('rajat mahajan','ddg@demo'),
        ('june wu','ddg@demo'),
        ('chuck davenport','ddg@demo'),
        ('siddhant patra','ddg@demo'),
        ('anito joshy','ddg@demo'),
        ('kshitij rastogi','ddg@demo'),
        ('shantanu jahagirdar','ddg@demo'),
        ('vishi hariharan','ddg@demo'),
        ('stephanie yee','ddg@demo'),
        ('mark burton','ddg@demo'),
        ('steven ren','ddg@demo')
        ], auto_hash=True, hash_function=None):
        """
